...
const tailor_portfolio_schema = mongoose.Schema({
    tailor_id: {
...
const tailor_portfolio = mongoose.model("tailor_portfolio", tailor_portfolio_schema);

module.exports = tailor_portfolio