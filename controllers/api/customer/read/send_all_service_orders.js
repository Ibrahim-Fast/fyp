...
const send_all_service_orders = async (req, res) => {
    try {
        ...
        results = await service_orders.find({ customer_id: c._id }, ["-updatedAt", "-__v", "-customer_id", "-tailor_id", "-completion_pictures",]).limit(10).sort('-createdOn')
...
module.exports = send_all_service_orders