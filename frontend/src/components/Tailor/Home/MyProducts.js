        ...
        <Container className='align-content-center justify-content-center my-2'>
            ...
            <Row className='justify-content-between align-content-center'>
                {(responseState === undefined || responseState.results === undefined || responseState.results.length === 0) ? <>
                    <h1>
                        ..Currently No Products to Show try reloading..
                    </h1>
                </>
                    : responseState.results.map((i, n) => {
                        return (
                            <Col className='mx-auto' key={n} xs={12} sm={10} md={6} lg={4} xxl={3} >
                                <Card key={i._id} className='m-3 p-3' style={{ maxHeight: '530px', minHeight: '530px' }}>
                                    <Col className='justify-content-end align-content-end text-end'>
                                        <Badge bg='success' >{(n + 1) + ((current_page - 1) * 10)}</Badge>
                                    </Col>

                                    <Card.Body style={{ textDecoration: 'none' }} as={Link} to={`/products/${i.shop_id}/${i._id}`}>
                            ...
                            {(i.product_categories && (
                              (i.product_categories.age_group && i.product_categories.age_group !== '-') ||
                              (i.product_categories.gender && i.product_categories.gender !== '-') ||
                              (i.product_categories.article_type && i.product_categories.article_type !== '-') ||
                              (i.product_categories.season && i.product_categories.season !== '-') ||
                              (i.product_categories.wear_type && i.product_categories.wear_type !== '-')
                            )) ?
                              "Categories:" : ""}
                            <br />
                            {(i.product_categories) ?
                            ...
                            <br />
                                                    ...
                                                    {(i.visibility === 1) ?
                                                        ...
                                                        <Badge bg="danger">NOT VISIBLE</Badge>
                                                    }
                                                    <br />
                                                    {(i.stock_status === 0 || i.stock_amount === 0) ?
